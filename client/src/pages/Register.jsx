...
const Register = () => {
  ...
  return (
    <div className="flex min-h-[calc(100vh-140px)] flex-1 flex-col justify-center px-6 py-12 lg:px-8 relative">
      {/* Background elements */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl h-[400px] bg-purple-600/10 blur-[120px] rounded-full pointer-events-none"></div>
      ...
      >
        <div className="glass-panel p-8 sm:p-10 rounded-3xl relative overflow-hidden">
          <div className="absolute top-0 right-0 p-8 opacity-5 pointer-events-none">
            <Zap className="h-48 w-48 text-purple-400" />
          </div>

          <div className="flex justify-center mb-6">
            <div className="bg-gradient-to-br from-indigo-500 to-purple-600 p-4 rounded-2xl text-white shadow-[0_0_30px_-5px_rgba(168,85,247,0.5)]">
              <Zap size={36} />
            </div>
          </div>
          ...
          <p className="text-center text-slate-400 mb-8">
            Join SpeedBooster and start optimizing today.
          </p>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="space-y-4">
              <div>
                <label htmlFor="name" className="block text-sm font-medium leading-6 text-slate-300 mb-1.5">
                  Full Name
                </label>
              ...
              <div>
                <label htmlFor="password" className="block text-sm font-medium leading-6 text-slate-300 mb-1.5">
                  Password
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
          ...
          <p className="mt-8 text-center text-sm text-slate-400">
            ...
            <Link to="/login" className="font-semibold leading-6 text-indigo-400 hover:text-indigo-300 transition-colors">
              Sign in instead
            </Link>
          </p>
        </div>
